						...
						<div class="form-group @if($errors->get('nameofsection')) has-error @endif">
							<div class="row gutter">
								<div class="col-md-12">
									...
									<input id="nameofsection" type="text" required class="form-control" placeholder="Nom de la section" name="nameofsection"  value="{{ $sectiontoedit->nameofsection }}">
								</div>
							</div>
						</div>
						<div class="form-group @if($errors->get('num_section')) has-error @endif">
								<div class="row gutter">
									<div class="col-md-12">
										...
										<input id="num_section" type="text" required class="form-control" placeholder="Numéro de la section" name="num_section"  value="{{ $sectiontoedit->num_section }}">
									</div>
								</div>
							</div>
							<div class="form-group @if($errors->get('refeent_secteur')) has-error @endif">
									<div class="row gutter">
										<div class="col-md-12">
											...
											<input id="refeent_secteur" type="text" required class="form-control" placeholder="Référent secteur" name="refeent_secteur"  value="{{ $sectiontoedit->refeent_secteur }}">
										</div>
									</div>
								</div>
