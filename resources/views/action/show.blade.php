...
<div class="row gutter" style="margin-left:  20%;">
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
			<div class="panel">
                ...
                <div class="panel-body">
					...
					?>
						...
						<form accept-charset="utf-8" id="form" name="form" method="post" action="{{ url('action/modifydemandebyreferent/'.$demande->id) }}"  enctype="multipart/form-data">
								@if (count($errors))
			...
			@if ($demande->etap=="REFERENT OUTILLAGE" AND ($demande->statusfdevalidation=="En attente" OR ($demande->statusfdevalidation="Rejetée" AND $demande->rejeterpar="COORDINATEUR BE")))
						<div class="row gutter">
										<div class="col-md-4 col-md-offset-5">
											<a id="{{ $demande->id }}" onclick="savebeforeapprouvebyref(this)"
...
<div class="modal fade" id="modalForm" tabindex="-1" role="dialog" aria-labelledby="modalForm">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<form  accept-charset="utf-8" id="form" name="formapprouve" method="post" action="{{ url('action/approverByRefOutile/'.$demande->id) }}" >
				...
				<div class="modal-body">
						...
						<div class="form-group">
							...
							<textarea class="form-control messagapprove" name="comment" id="message-text" value=""></textarea>
						</div>					
				</div>
	...
	<div class="modal fade" id="modalForm2" tabindex="-1" role="dialog" aria-labelledby="modalForm2">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<form accept-charset="utf-8" id="form" name="formreject" method="post" action="{{ url('action/rejeterByRefOutile/'.$demande->id) }}">
				<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
