	...
	<div class="row gutter" style="margin-left:  20%;">
			...
			<div class="panel">
				<div class="panel-heading">
					...
					<h4>NOUVELLE DEMANDE : <p align='center'>Réference de votre commande: <d id='sectionnum'> </d>_{{ substr( date("Y/m/d"), -8)}}_N{{$nbcommandejour}}<d id='typeinterref'>C </d></p> <h4>
						...
						<div class="form-group">
								...
								<div class="row gutter">
									<div class="col-md-4 selectContainer">
										...
										<select  class="form-control red section" required name="section" id="getinfosection" >
											...
											<option value='{{ $section->id}}' class="{{ $section->nameofsection}}+{{ $section->refeent_secteur}} ">{{ $section->num_section }}</option>"											@endforeach
										</select>
									</div>
									<div class="col-md-4 selectContainer" >
								...
								<div class="row gutter">
									<div class="col-md-4 selectContainer">
										...
										<p type="text"  class="form-control gridp" placeholder="ex:BEZZOT T" name="alivrera" >{{ $_SESSION['glpifirstname'][0]}}.{{ $_SESSION['glpirealname'] }}</p>
									</div>
								</div>
								<div class="row gutter">															
									<div class="col-md-6 selectContainer">
								...
								<div class="row gutter">
									<div class="col-md-12">
										...
										<textarea placeholder="ici" class="form-control fonctionoutil" name="fonctionoutil" rows="5" onchange="onchangedescription(this)"></textarea>
									</div>
								</div>
								<div class="row gutter">
									<div class="col-md-12">
